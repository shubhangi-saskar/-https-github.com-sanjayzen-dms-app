...
public class TabDocument extends Composite implements HasDocumentEvent, HasDocumentHandlerExtension, HasPropertyGroupHandlerExtension {
	...
	public void setProperties(GWTDocument doc) {
		...
		if (previewVisible) {
			System.out.println("111111111111111111111111111111111111111 :" + doc.getName());
			System.out.println("222222222222222222222222222222222222222 :" + doc.isConvertibleToSwf());
			System.out.println("333333333333333333333333333333333333333 :" + doc.getMimeType());
